...
/// A smooth step edge widget with rounded corners.
///
/// This widget renders an edge with rounded 90-degree corners.
class SmoothStepEdge extends StatelessWidget {
  /// Creates a smooth step edge.
  ...
  Widget build(BuildContext context) {
    ...
    final edgePath = SmoothStepEdgePath.getSmoothStepPath(
      sourceX: sourceX,
      sourceY: sourceY,
      targetX: targetX,
      targetY: targetY,
      ...
      borderRadius: borderRadius ?? SmoothStepEdgePath.defaultBorderRadius,
      offset: offset ?? SmoothStepEdgePath.defaultOffset,
    );
